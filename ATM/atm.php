...
<div class="container">
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class=row>
                <form action="verifyaton.php" method="post">
			...
			<div class="input-container">
				<div class="row">
					<span class="req-input" >
						<span class="input-status" data-toggle="tooltip" data-placement="top" title="Enter Your CNIC"> </span>
						<input type="text" data-min-length="8" placeholder="CNIC" name="cnic">
					</span>
				
					<span class="req-input">
						<span class="input-status" data-toggle="tooltip" data-placement="top" title="Enter Your Voucher Code"> </span>
						<input type="text" placeholder="Voucher Code" name="vno">
					</span>
				
					<span class="req-input">
						<span class="input-status" data-toggle="tooltip" data-placement="top" title="Enter Your Secter Pin"> </span>
						<input type="text" placeholder="Pin" name="pin">
					</span>
				</div>
				<div class="row submit-row">
					<button type="submit" class="btn btn-block submit-form" name="s">Withdraw</button>
				</div>
                <br>
                <br>
			</div>
...
<footer class="container-fluid text-center">
  ...
  <p>All Rights Reserved For base Squad</p>
</footer>
